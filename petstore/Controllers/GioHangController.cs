...
namespace petstore.Controllers
{
    public class GioHangController : Controller
    {
        ...
        public ActionResult MuaNgay(int id, FormCollection collection)
        {
            ...
            {
                //sanpham.iSoluong++;
                TempData["kmua"] = "<script>alert('Sản phẩm không được vượt quá số lượng tồn');</script>";
        ...
        public ActionResult CapnhapGiohang(int id, FormCollection collection)
        {
            ...
            if (!string.IsNullOrEmpty(collection["txtSoLg"].ToString()))
            {
                ...
                if (sanpham != null)
                {
                    ...
                    {
                        TempData["msg"] = "Sản phẩm không được vượt quá số lượng tồn";
                    }
                    else if (inputSL < 0)
                    {
                        TempData["msg"] = "Sản phẩm không nhỏ hơn 0";
                    }
                    else
                    {
                ...
                {
                    TempData["msgnull"] = "Sản phẩm không được để trống";
                    sanpham.iSoluong = inputSL;
                }
